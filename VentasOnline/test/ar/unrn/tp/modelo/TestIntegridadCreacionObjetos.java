...
public class TestIntegridadCreacionObjetos {
	...
	public void creacionClienteConDniNull() {
		Integer dni = null;
		Cliente cliente = new Cliente(1, dni, "Rodrigo", "Calizaya", "rodrigocalizaya111999@gmail.com");
	}
	
	@Test(expected = RuntimeException.class)
	public void creacionClienteConNombreNull() {
		Cliente cliente = new Cliente(1, 41478211, null, "Calizaya", "rodrigocalizaya111999@gmail.com");
	}
	
	@Test(expected = RuntimeException.class)
	public void creacionClienteConNombreVacio() {
		Cliente cliente = new Cliente(1, 41478211, "","Calizaya", "rodrigocalizaya111999@gmail.com");
	}
	
	@Test(expected = RuntimeException.class)
	public void creacionClienteConApellidoNull() {
		Cliente cliente = new Cliente(1, 41478211, "Rodrigo", null, "rodrigocalizaya111999@gmail.com");
	}
	
	@Test(expected = RuntimeException.class)
	public void creacionClienteConApellidoVacio() {
		Cliente cliente = new Cliente(1, 41478211, "Rodrigo", "", "rodrigocalizaya111999@gmail.com");
	}
	
	@Test(expected = RuntimeException.class)
	public void creacionClienteConEmailInvalido() {
		Cliente cliente = new Cliente(1, 41478211, "Rodrigo","Calizaya", "rodrigocalizaya111999gmail.com");
	}
